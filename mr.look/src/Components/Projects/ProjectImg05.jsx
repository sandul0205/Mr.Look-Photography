...
const ProjectImg05 = () => {
  ...
  return (
    ...
    <div className='absolute top-[1370px] left-[100px] bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center cursor-pointer'>
