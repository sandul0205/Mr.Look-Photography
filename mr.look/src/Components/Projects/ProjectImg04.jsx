...
const ProjectImg04 = () => {
  ...
  return (
    ...
    <div className='absolute top-[670px] right-[60px] bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center cursor-pointer'>
